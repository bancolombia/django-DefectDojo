...
class Risk_Acceptance(models.Model):
    ...
    long_term = models.BooleanField(default=False, null=False, blank=True, verbose_name=_("Long Term"), help_text=_("If checked, this risk acceptance is considered long term."))
