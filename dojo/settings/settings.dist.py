...
env = environ.FileAwareEnv(
    ...
    DD_HC_PARTICIPATION_POSTULATED_ENDPOINT=(str, ""),
    DD_HC_PARTICIPATION_ALREADY_IN_HC_ENDPOINT=(str, ""),
    DD_HC_PARTICIPATION_POSTULATED_TIMEOUT_SECONDS=(int, 30),
    DD_HC_PARTICIPATION_POSTULATED_AUTH_TOKEN=(str, ""),
    DD_HC_PARTICIPATION_POSTULATED_TAGS=(list, ["fluidattacks", "fluid_hacker", "devsecops_hacker"]),
    DD_HC_PARTICIPATION_DAYS=(int, 300),
    DD_HC_PARTICIPATION_POSTULATED_CLASSID=(list, ["BMC_APPLICATION"]),
    DD_HC_PARTICIPATION_POSTULATED_BUSINESS_CRITICALITY=(list, []),
    DD_HC_MANUAL_POSTULATION_CRITERIA=(list, []),
    DD_HC_CONFIRM_INGRESS_POSTULATION_CRITERIA=(list, []),
    ...
    DD_SHOW_SLA_DISPLAY_PRIORITY=(bool, False),
...
HC_PARTICIPATION_POSTULATED_ENDPOINT = env("DD_HC_PARTICIPATION_POSTULATED_ENDPOINT")
HC_PARTICIPATION_ALREADY_IN_HC_ENDPOINT = env("DD_HC_PARTICIPATION_ALREADY_IN_HC_ENDPOINT")
HC_PARTICIPATION_POSTULATED_TIMEOUT_SECONDS = env("DD_HC_PARTICIPATION_POSTULATED_TIMEOUT_SECONDS")
HC_PARTICIPATION_POSTULATED_AUTH_TOKEN = env("DD_HC_PARTICIPATION_POSTULATED_AUTH_TOKEN")
HC_PARTICIPATION_POSTULATED_TAGS = env("DD_HC_PARTICIPATION_POSTULATED_TAGS")
HC_PARTICIPATION_DAYS = env("DD_HC_PARTICIPATION_DAYS")
HC_PARTICIPATION_POSTULATED_CLASSID = env("DD_HC_PARTICIPATION_POSTULATED_CLASSID")
HC_PARTICIPATION_POSTULATED_BUSINESS_CRITICALITY = env("DD_HC_PARTICIPATION_POSTULATED_BUSINESS_CRITICALITY")
HC_MANUAL_POSTULATION_CRITERIA = env("DD_HC_MANUAL_POSTULATION_CRITERIA")
HC_CONFIRM_INGRESS_POSTULATION_CRITERIA = env("DD_HC_CONFIRM_INGRESS_POSTULATION_CRITERIA")
...
SHOW_SLA_DISPLAY_PRIORITY = env("DD_SHOW_SLA_DISPLAY_PRIORITY")
